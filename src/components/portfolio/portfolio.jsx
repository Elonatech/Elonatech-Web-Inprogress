...
import Ebrand1 from './caption/Elonatech/Branding/bangetelo2.jpg';
import Ebrand2 from './caption/Elonatech/Branding/cup.png';
import Ebrand3 from './caption/Elonatech/Branding/elona jersey.jpg';
import Ebrand4 from './caption/Elonatech/Branding/elona kit.jpg';
import Ebrand5 from './caption/Elonatech/Branding/elona paper bag.jpg';
import Ebrand6 from './caption/Elonatech/Branding/elona sationaries brand.jpg';
import Ebrand7 from './caption/Elonatech/Branding/elonatech Business cards preview.jpg';
import Ebrand8 from './caption/Elonatech/Branding/vertical-id-cards-mockup.jpg';
...
import Edigital8 from './caption/Elonatech/Digital marketing/elonatech-website-design.jpg';
import Eweb1 from './caption/Elonatech/Web design and development/template-for-web-portfolio-4.jpg';


import Oweb1 from './caption/Ozone Cinemas/Web design and development/Screenshot 2023-11-01 131115.png';
import Oweb2 from './caption/Ozone Cinemas/Web design and development/Screenshot 2023-11-01 131216.png';
import Oweb3 from './caption/Ozone Cinemas/Web design and development/Screenshot 2023-11-01 131316.png';
import Oweb4 from './caption/Ozone Cinemas/Web design and development/Screenshot 2023-11-01 131419.png';
import Oweb5 from './caption/Ozone Cinemas/Web design and development/Untitled-1.jpg';
import Oweb6 from './caption/Ozone Cinemas/Web design and development/template-for-web-portfolio-22.jpg';

import Odigital from './caption/Ozone Cinemas/Digital marketing/Blue-bettle-movie-poster.jpg'
import Odigital2 from './caption/Ozone Cinemas/Digital marketing/The-Marvel-movie-premiere-new.jpg'
import Odigital3 from './caption/Ozone Cinemas/Digital marketing/biodun okeowo fire.png'
import Odigital4 from './caption/Ozone Cinemas/Digital marketing/concessions 2.png'
import Odigital5 from './caption/Ozone Cinemas/Digital marketing/merrymen-now-showing-original-.jpg'
import Odigital6 from './caption/Ozone Cinemas/Digital marketing/mission-impossible-promo.png'
import Odigital7 from './caption/Ozone Cinemas/Digital marketing/monday-special-new-2.jpg'
import Odigital8 from './caption/Ozone Cinemas/Digital marketing/ozone-cinema-day.jpg'
import Odigital9 from './caption/Ozone Cinemas/Digital marketing/ozone-cinema-independence-day-design.jpg'
import Odigital10 from './caption/Ozone Cinemas/Digital marketing/ozone-treasure-hunt.jpg'
...
<div class="tab_body" style={{overflow:"auto" , height:"30rem"}}>
  ...
  <div className="row">
        <div className="col-md-12">
          <div className="card">
            <img src={Rweb1} alt="" className='img-fluid'  style={{height:"28rem"}} />
          </div>
          </div>
...
<div className="container mb-5">
  <div className="row g-0">
    <div className="col-md-2">
      ...
      <li data-tc="tab_item_1" class="dropdown-item mt-2 p-3 "> <h6>Web Design</h6></li>
      <li data-tc="tab_item_2" onMouseEnter={scrollToHeader} class="dropdown-item mt-2 p-3 pe-5"><h6>Motion Graphic</h6></li>
      <li data-tc="tab_item_3" onMouseEnter={scrollToHeader} class="dropdown-item mt-2 p-3 pe-5"><h6>Digital Market</h6></li>
      {/* <li data-tc="tab_item_3" class="dropdown-item mt-2 p-4 ps-1"><h6>Digital Market</h6></li> */}
...
<div class="tab_body " style={{overflow:"auto" , height:"30rem"}}>
  ...
  <div className="row">
        <div className="col-md-12">
          <div className="card">
            <img src={Eweb1} alt="" className='img-fluid'  style={{height:"28rem"}} />
          </div>
          </div>
...
{/* motion graphics */}
<div class="tab_item tab_item_2"  style={{display:"none"}}>
    <video controls className='img-fluid rounded' loop src='https://res.cloudinary.com/pentecostal-fellowship-of-nigeria-lagos/video/upload/v1698682326/Digital_marketing_ad_for_elonatech_new_fagavk.mp4' type="video/mp4" />
    <video controls className='img-fluid rounded' loop src='https://res.cloudinary.com/pentecostal-fellowship-of-nigeria-lagos/video/upload/v1698682349/elonatech_hardware_video_2_pktn5f.mp4' type="video/mp4" />
    <video controls className='img-fluid rounded' loop src='https://res.cloudinary.com/pentecostal-fellowship-of-nigeria-lagos/video/upload/v1698682252/Corporate_Website_immoht.mp4' type="video/mp4" />
    <video controls className='img-fluid rounded' loop src='https://res.cloudinary.com/pentecostal-fellowship-of-nigeria-lagos/video/upload/v1698682209/Computer_repairs_-_Elonatech_vdpkfr.mp4' type="video/mp4" />
...
<div class="tab_item tab_item_3" style={{display:"none"}}>
   <div className="container">
    ...
    <div className="col-md-4">
      <div className="shadow">
      <img src={Edigital1} className='img-fluid rounded' alt="" />
      </div>
      </div>
    <div className="col-md-4">
      <div className="shadow">
      <img src={Edigital2} className='img-fluid rounded' alt="" />
    </div>
    </div>
    <div className="col-md-4">
      <div className="shadow">
      <img src={Edigital3} className='img-fluid rounded' style={{height:"18rem"}}  alt="" />
        </div>
        </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Edigital4} className='img-fluid rounded' alt="" />
      </div>
      </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Edigital5} className='img-fluid rounded' alt="" />
    </div>
    </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Edigital6} className='img-fluid rounded' alt="" />
        </div>
        </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Edigital7} className='img-fluid rounded' alt="" />
        </div>
        </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Edigital8} className='img-fluid rounded' alt="" />
        </div>
        </div>
    </div>
   </div>
...
<div class="tab_item tab_item_4" style={{display:"none"}}>
    ...
    <div className="container">
      ...
      <div className="col-md-4">
        <div className="shadow">
        <img src={Ebrand1} className='img-fluid rounded' alt="" />
        </div>
        </div>
      <div className="col-md-4">
        <div className="shadow">
        <img src={Ebrand2} className='img-fluid rounded' alt="" />
      </div>
      </div>
      <div className="col-md-4">
        <div className="shadow">
        <img src={Ebrand3} className='img-fluid rounded' style={{height:"18rem"}}  alt="" />
          </div>
          </div>
      <div className="col-md-4 mt-4">
        <div className="shadow">
        <img src={Ebrand4} className='img-fluid rounded' alt="" />
        </div>
        </div>
      <div className="col-md-4 mt-4">
        <div className="shadow">
        <img src={Ebrand5} className='img-fluid rounded' alt="" />
      </div>
      </div>
      <div className="col-md-4 mt-4">
        <div className="shadow">
        <img src={Ebrand6} className='img-fluid rounded' alt="" />
          </div>
        </div>
      <div className="col-md-4 mt-4">
        <div className="shadow">
        <img src={Ebrand7} className='img-fluid rounded' alt="" />
          </div>
        </div>
      <div className="col-md-4 mt-4">
        <div className="shadow">
        <img src={Ebrand8} className='img-fluid rounded' alt="" />
          </div>
        </div>
      </div>
     </div>
...
<div class="tab_body" style={{overflow:"auto" , height:"29rem"}}>
  ...
  <div className="row">
        <div className="col-md-12">
          <div className="card">
            <img src={Oweb1} alt="" className='img-fluid'  style={{height:"28rem"}} />
          </div>
          </div>
        <div className="col-md-5 mt-2">
          <div className="">
           <img src={Oweb2} className='img-fluid shadow' style={{height:"18.9rem" , marginTop:"2.4rem"}}    alt="" />
        </div>
        </div>
        <div className="col-md-7 mt-5">
          <div className="shadow">
            <img src={Oweb3} className='img-fluid rounded shadow' alt="" />
          </div>
        </div>
        <div className="col-md-7 mt-5">
          <div className="">
            <img src={Oweb4} className='img-fluid rounded shadow' alt="" />
          </div>
        </div>
        <div className="col-md-5 mt-5">
          <div className="">
            <img src={Oweb5} className='img-fluid rounded shadow' style={{height:"20rem" , width:"2000rem"}} alt="" />
          </div>
        </div>
        <div className="col-md-5 mt-5">
          <div className="">
            <img src={Oweb6} className='img-fluid rounded shadow' style={{height:"20rem" , width:"2000rem"}} alt="" />
          </div>
        </div>
  </div>
  </div>
...
{/* digital */}
  ...
  <div className="container">
    ...
    <div className="col-md-4">
      <div className="shadow">
      <img src={Odigital} className='img-fluid rounded' alt="" />
      </div>
      </div>
    <div className="col-md-4">
      <div className="shadow">
      <img src={Odigital2} className='img-fluid rounded' alt="" />
    </div>
    </div>
    <div className="col-md-4">
      <div className="shadow">
      <img src={Odigital3} className='img-fluid rounded' style={{height:"18rem"}}  alt="" />
        </div>
        </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital4} className='img-fluid rounded' alt="" />
      </div>
      </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital5} className='img-fluid rounded' alt="" />
    </div>
    </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital6} className='img-fluid rounded' alt="" />
        </div>
        </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital7} className='img-fluid rounded' alt="" />
        </div>
    </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital8} className='img-fluid rounded' alt="" />
        </div>
    </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital9} className='img-fluid rounded' alt="" />
        </div>
    </div>
    <div className="col-md-4 mt-4">
      <div className="shadow">
      <img src={Odigital10} className='img-fluid rounded' alt="" />
        </div>
    </div>
    </div>
   </div>
