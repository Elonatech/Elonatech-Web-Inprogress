...
<div id="about" class="basic-1 bg-secondary mb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-container first ">
                        <h2 class="text-white">Hi there I'm Mark,</h2>
                        <p class="text-white">And I love to create beautiful and efficient websites for my customers. I love going through the entire process with the customer from concept, to design and then development and launch</p>
                    </div> 
                </div> 
                <div class="col-lg-4">
                    <div class="text-container second">
                        <div class="time">2019 - PRESENT</div>
                        <h6 class="text-white">Freelance Web Developer</h6>
                        <p class="text-white">Working happily on my own web projects</p>
                        <div class="time">2018 - 2019</div>
                        <h6 class="text-white">Lead Web Developer</h6>
                        <p class="text-white"> Beautiful project for a major digital agency</p>
                    </div> 
                </div>
                <div class="col-lg-4">
                    <div class="text-container third">
                        <div class="time">2017 - 2018</div>
                        <h6 class="text-white">Senior Web Designer</h6>
                        <p class="text-white"> Inhouse web designer for ecommerce firm</p>
                        <div class="time">2016 - 2017</div>
                        <h6 class="text-white">Junior Web Designer</h6>
                        <p class="text-white">Junior web designer for small web agency</p>
                    </div> 
                </div> 
            </div> 
        </div>
