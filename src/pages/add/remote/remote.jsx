import './remote.css';
import image from './img/african-woman-sitting-computer-science-class-lady-with-glasses-female-student-sitting-computer_1157-42317.jpg'
import image1 from './img/cost-reduction-business-concept-finance_220873-30348.jpg'
import image2 from './img/sand-running-through-bulbs_488220-37412.jpg'
import image3 from './img/human-resources-concept-with-man.jpg'
import image4 from './img/top-view-tools-clockwork-spare-parts_696657-21926.jpg'
import photo1 from './img/teleworking.png'
import photo2 from './img/sharing.png'
import photo3 from './img/remote-access.png'
import photo4 from './img/image-asset-removebg-preview.png'
import remoteHeader from './img/young-man-using-headphones-listen-music-while-working-from-home-office-computer.jpg'

const Remote = () => {
  return (
<section>
{/* header */}
<div class="container-fluid  py-5 " style={{height:"500px" , marginBottom:"50px", backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${remoteHeader})`, backgroundRepeat:"no-repeat" , backgroundPosition:"center", backgroundSize:"cover"}}>
 <div class="py-5 mt-5 ">
   <h2 class=" mt-5 text-white text-center">Remote Support</h2>
   <h5 class=" mt-4 text-white text-center">Access to Experts offering Round-the-Clock maintenance aimed at Increasing productivity</h5>
   <p class="lead text-white text-center">Remotely accessing and controlling computers or mobile devices anytime, anywhere using reliable and secure remote connections</p>
 </div>
 </div> 
