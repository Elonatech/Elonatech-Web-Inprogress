...
{/* header */}
<div class="container-fluid  py-5 " style={{height:"500px" , marginBottom:"70px", backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${animationHeader})`, backgroundRepeat:"no-repeat" , backgroundPosition:"center", backgroundSize:"cover"}}>
 <div class="py-5 mt-5 ">
...
{/* VIDEO CARD */}
   <div className=" container ">
     <h1 className='text-center mb-5  fw-bold'>2D AND 3D ANIMATION VIDEO TEMPLATE</h1>
