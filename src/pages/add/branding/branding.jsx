...
import brandingHeader from './Brand-Img/brandingHeader.jpg'
import './branding.css';
...
import IMAGE1 from '../branding/Brand-Img/brandingHeader.jpg';
import IMAGE2 from '../branding/Brand-Img/project-14-850x540-_1__720.jpg';
import IMAGE3 from '../branding/Brand-Img/project-14-850x540-_3_720.jpg';
import ELONATECH1 from './Brand-Img/branding.png'
...
import Client8 from './Brand-Img/ozone_cinemas_logo-removebg-preview_360.png'
 import bg from './Brand-Img/bg.png.png'
...
const Branding = () => {
  ...
  {/* header */}
<div class="container-fluid  py-5 " style={{height:"500px" , marginBottom:"100px", backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${brandingHeader})`, backgroundRepeat:"no-repeat" , backgroundPosition:"center", backgroundSize:"cover"}}>
 <div class="py-5 mt-5 ">
   <h2 class=" mt-5 text-white text-center">Brand Identity</h2>
   <h5 class=" mt-4 text-white text-center">Need content</h5>
   <p class="lead text-white text-center">“A Brand Is No Longer What We Tell The   Consumer It Is - It Is What  Consumers Tell EachOther It Is.” – <span>SCOTT COOK</span></p>
 </div>
 </div> 
 ...
 <div className="container mt-5" >
          ...
          <div class="row justify-content-evenly gx-4 mt-5">
            ...
            It’s much more than a logo, Elonatech brand identity development service is actually at the intersection of strategy and design.</p>
              ...
              <div class=" col-md-6">
              <img src={ELONATECH1} class="img-fluid rounded " alt="" />
              </div>
            </div>

            <div class="row justify-content-evenly mt-4  flex-column-reverse flex-lg-row">
              <div class="col-md-6">
                <img src={ELONATECH2} class="img-fluid rounded" alt="" />
              </div>
              <div class="col-md-6 ">
                <h3 className='text-danger  pb-2'>Why Does Brand Identity Matter?</h3>
                ...
                <h3 className='text-danger pb-2'>What Makes a Good Brand? </h3>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
              <div className=" text-center">
                <h2 className='FAQ' style={{color:"#2b5592", fontWeight:"800"}}>FREQUENTLY ASKED QUESTIONS</h2>
            ...
            <div class="accordion accordion-flush" id="faqlist" >
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5">
