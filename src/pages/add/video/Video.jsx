...
import videoHeader from './img/close-up-sound-engineer-studio-with-equipment_1157-47928.jpg';
...
const Video = () => {
  return (
    ...
    <>
  {/* header */}
  <div class="container-fluid  py-5 " style={{height:"500px" , marginBottom:"100px", backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${videoHeader})`, backgroundRepeat:"no-repeat" , backgroundPosition:"center", backgroundSize:"cover"}}>
 <div class="py-5 mt-5 ">
   <h2 class=" mt-5 text-white text-center">Video Editing</h2>
   <h5 class=" mt-4 text-white text-center">Putting together, cleaning up and finalizing a video output</h5>
   <p class="lead text-white text-center">We provide comprehensive video and photography solutions for events of every size, anywhere in Nigeria. Whether it’s a conference, training, presentation, exhibitions etc</p>
 </div>
 </div> 
    ...
    <div class="container  ">
      <div class="row  mt-5">
          ...
          <div class="clearfix align-items-center" data-aos="fade-left" data-aos-duration="2000">
           <div class=" "   > 
              <img src={ CAMERA} alt=""class="col-md-6 float-md-end mb-3 ms-md-3 img-fluid " />
            </div>
          ...
          <div class="clearfix mt-5" data-aos="fade-right" data-aos-duration="2000">
                <img src={Photo} class="col-md-6 float-md-end mb-3 ms-md-3 img-fluid" alt="..." />
...
<div className=""  style={{ backgroundImage: `url(${BackgroundImage2})`, backgroundSize:'cover', backgroundRepeat:'no-repeat', height:'300px', color:'white'}}>
          <div className="text-start pl-4 ms-5">
