        ...
        <div className="" style={{}}>
            <div className="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder='Brand Name'  aria-describedby="emailHelp"  />
                </div>
            </div>
             ...
             <div className="row">
                ...
                <div class="mb-3 col-md-4 mt-2">             
                    ...
                    <input type="number" id="price" class="form-control" onChange={(e) => setPrice(e.target.value)}  name="price" placeholder="Enter price" ></input>
                </div>
                <div class="mb-3 col-md-4">
                    <label for="formFile" class="form-label">File</label>
                    <input class="form-control" type="file" name="files" multiple  onChange={(e)=>setCloudinary_id(e.target.files[0])} id="formFile" />  
                </div>
